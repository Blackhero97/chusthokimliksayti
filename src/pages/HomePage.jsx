  ...
  const systemStats = [
    {
      ...
      label: language === "uz" ? "Axlat mashinalari" : "Мусоровозы",
      icon: Recycle,
    },
    {
    ...
    },
    {
      ...
      label: language === "uz" ? "Oylik chaqiruvlar" : "Обращения/месяц",
      icon: Phone,
    },
    {
      number: `${systemStatsValues.satisfaction}%`,
      label: language === "uz" ? "Qoniqish darajasi" : "Удовлетворенность",
      icon: Users,
    },
    {
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-28 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div
              data-aos="fade-down"
              className="inline-flex items-center gap-2 mb-4 sm:mb-6 px-3 sm:px-5 py-2 bg-blue-600 text-white text-xs sm:text-sm font-medium rounded-full shadow-lg"
            >
              {language === "uz"
            ...
            <h1
              data-aos="fade-up"
              data-aos-delay="100"
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-3 sm:mb-4 md:mb-5 text-gray-900 tracking-tight leading-tight"
            >
            ...
            <p
              data-aos="fade-up"
              data-aos-delay="200"
              className="text-lg sm:text-xl md:text-2xl mb-4 sm:mb-6 text-gray-700 font-medium"
            >
            ...
            <p
              data-aos="fade-up"
              data-aos-delay="300"
              className="text-sm sm:text-base md:text-lg text-gray-600 mb-6 sm:mb-8 md:mb-10 leading-relaxed max-w-3xl mx-auto px-2 sm:px-0"
            >
              {language === "uz"
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="400"
              className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mb-8 sm:mb-12 md:mb-16 px-4 sm:px-0"
            >
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-3xl mx-auto leading-relaxed px-4">
              {language === "uz"
                ...
                : 'Sistem "Чуст умный город" - крупный проект в рамках стратегии "Цифровой Узбекистан - 2030" Президента Республики Узбекистан.'}
            </p>
          </div>
          ...
          <div className="text-center mb-12 sm:mb-16" data-aos="fade-up">
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-4">
              {language === "uz"
                ...
                : "Текущие показatели, управляемые через систему"}
            </p>
          </div>
          ...
          >
            {systemStats.map((stat, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`${colors[index].bg} ${colors[index].border} ${colors[index].glow} backdrop-blur-lg rounded-2xl p-4 md:p-5 text-center transition-all duration-700 hover:shadow-2xl hover:scale-[1.03] group relative overflow-hidden cursor-pointer`}
                  style={{
                ...
                >
                  ...
                  <div className="relative mb-4 flex justify-center">
                    {/* Main icon box */}
                    <div
                      className={`${colors[index].iconBg} w-14 h-14 rounded-xl ${colors[index].icon} flex items-center justify-center shadow-md transition-all duration-700 relative z-10 group-hover:scale-110 group-hover:rotate-6 border border-white/50`}
                      style={{
                        boxShadow:
                          "inset 0 2px 6px rgba(255,255,255,0.8), 0 4px 15px rgba(0,0,0,0.1)",
                      }}
                    >
                      ...
                      {/* Inner accent dot */}
                      <div
                        className={`absolute -top-1 -right-1 w-2 h-2 bg-gradient-to-r ${colors[index].accent} rounded-full opacity-70 group-hover:opacity-100 transition-opacity duration-500`}
                      ></div>
                    </div>

                    {/* Subtle glow effect */}
                    <div
                      className={`absolute inset-0 w-14 h-14 mx-auto rounded-xl bg-gradient-to-r ${colors[index].accent} opacity-0 group-hover:opacity-15 transition-opacity duration-700 blur-sm`}
                    ></div>
                  </div>
                  <div className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-900 bg-clip-text text-transparent mb-2 relative z-10 transition-all duration-700 group-hover:scale-105">
                    {stat.number}
                  </div>
                  <div className="text-xs font-medium text-gray-600 text-center relative z-10 leading-relaxed group-hover:text-gray-800 transition-all duration-500 px-1">
                    {stat.label}
                  </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div
            data-aos="fade-up"
            data-aos-delay="200"
            className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-4 md:p-5"
          >
